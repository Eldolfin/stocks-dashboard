...
### Required Tools
- **just** - Task runner (install: `wget -qO- 'https://github.com/casey/just/releases/download/1.36.0/just-1.36.0-x86_64-unknown-linux-musl.tar.gz' | tar -xzf- && sudo mv just /usr/local/bin/`)
